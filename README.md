...
Summary show the Min CPU used for 3% and Max is more then 103% with already said it is anomaly. Median and Mean is almost the same value.
         ...
         hist (h$cpu_usage) 
![ScreenShot](https://raw.github.com/{IrinaMax}/{CPU-usage-and-anomaly-detection}/{https://github.com/IrinaMax/CPU-usage-and-anomaly-detection/edit/master/README.md})
